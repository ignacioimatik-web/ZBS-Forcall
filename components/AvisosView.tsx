...
const fallbackCivilProtection: CivilProtectionUpdate = {
  ...
  summary:
    'Consulta el mapa oficial de 112 Comunitat Valenciana para revisar en tiempo real las avisos activas, las preemergencias y las emergencias meteorológicas aplicables a Els Ports y al interior norte de Castellón.',
  level: 'Verde',
  ...
  maps: [
    {
      ...
      imageUrl: 'https://www.112cv.gva.es/WebPublica-MapasOnLineV2/send/getMapaGeoserver?mapa=avisos',
      sourceUrl: 'https://www.112cv.gva.es/es/avisos-poblacion',
    },
    {
      id: 'preemergencias',
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {weatherLoading && currentWeather.length === 0 ? (
                <div className="sm:col-span-2 flex items-center justify-center py-12 text-gray-400">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest">{t('avisos.loadingWeather')}</span>
                </div>
              ) : null}
